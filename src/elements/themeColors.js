...
export const themeColors = {
  light: {
    palette: {
      ...
      primary: { main: "#f9971f", contrastText: "#000", bg: "#ffdeb6", mainbg: "#f9971f60", maintxt: "#ffb964", bgr: "#ffeed9", card: "#d7c7b4" },
  ...
  dark: {
    palette: {
      ...
      primary: { main: "#f9971f", contrastText: "#000", bg: "#ffdeb6", mainbg: "#f9971f60", bgr: "#ffeed9", maintxt: "#ffb964", card: "#d7c7b4" },
